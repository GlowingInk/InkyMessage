...
record UrlModifier(@NotNull @Subst("ms-web+lmao3") String scheme) implements Modifier.Plain {
    ...
    public @NotNull Component modify(@NotNull Component text, @NotNull String param, @NotNull String value) {
        ...
        return text.clickEvent(ClickEvent.clickEvent(
                ClickEvent.Action.OPEN_URL,
                ClickEvent.Payload.string(scheme + ":" + param)
        ));
    }
